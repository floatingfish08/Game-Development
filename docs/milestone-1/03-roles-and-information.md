...
- The Station Lead commits team decisions but cannot see or override all
  evidence.
- Information should create a reason to speak, not reward secrecy for its own
  sake.
- Combined roles create tension rather than superpowers.

## Player-count configurations

v0.7 asked the designer to challenge role count and supplied a 4–7 map. The
first commercial sessions remain 6–7. The 4- and 5-player maps are defined now
so later sessions do not invent a new story.

| Players | Configuration |
|---:|---|
| 4 | Station Lead + Protocol; Signal Analyst; Systems Engineer; Operations + Field Liaison |
| 5 | Station Lead; Signal Analyst; Systems Engineer; Operations Officer; Field Liaison + Protocol Officer |
| 6 | All six core roles |
| 7 | All six core roles plus Comms Officer |

Do not merge Signal Analyst with Systems Engineer, or Station Lead with Signal
Analyst. Those combinations concentrate too much technical interpretation or
decision authority in one player.

If one player combines Operations and Field Liaison, they may be pulled between
testing the lower road and prioritising Mara's voice. The design should force
that player to choose what matters most under time pressure, not simply give
them twice as much information.

With six players, Cordon formatting and readback appear as shared
Protocol/Signal prompts. With seven, those prompts move to the Comms Officer and
the final signal lane gains an extra specialist action. Story difficulty and
ending thresholds do not change merely because a seventh person joined.

## Role cards

| Role | What you protect | Private lens | Once-per-session intervention | AI-Ready Leader Map |
|---|---|---|---|---|
...
Interventions are safeguards, not “correct answer” buttons. The terminal
explains the cost or limitation before confirmation.

## Information matrix

Legend: **P** primary private evidence, **S** supporting private evidence, **D**
decision responsibility, **—** no unique information (shared display still
visible).
...
| Lower Route is beneath the station | Physical conduit evidence + legacy controller naming + Mara investigation context |
...
Confidence labels describe evidence quality, never the “correctness” of a
player's interpretation.

## Disconnection and absence

The facilitator can reassign a disconnected player's role terminal. If no player
can take it, that role's next primary card becomes shared after 30 seconds with
a fictional reason (“cross-terminal diagnostic copy”). The team pays a small
time cost, but critical evidence is never permanently lost to a technical
problem.
